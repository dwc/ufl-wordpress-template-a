...
?>
            <li id="active"><?php echo $parent->post_title . "\r"; ?>
                <ul id="secNav">
<?php
...
<?php
	...
	if(is_category() || is_single() || _uf_parent_is_news_page()) {
...
<?php
               ...
               elseif(_uf_parent_is_news_page()) {
                   foreach($categories as $category) {
?>
		      <li><a href="<?php echo get_category_link($category->cat_ID); ?>"><?php echo $category->cat_name; ?></a></li>
<?php
...
function _uf_parent_is_news_page() {
    $result = false;
